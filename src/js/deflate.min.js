...
//(function() {'use strict';
var n=void 0,w=!0;//,aa=this;
//function ba(f,d){var c=f.split("."),e=aa;!(c[0]in e)&&e.execScript&&e.execScript("var "+c[0]);for(var b;c.length&&(b=c.shift());)!c.length&&d!==n?e[b]=d:e=e[b]?e[b]:e[b]={}};
...
//ba("Zlib.Deflate",Ka);ba("Zlib.Deflate.compress",function(f,d){return(new Ka(f,d)).f()});ba("Zlib.Deflate.prototype.compress",Ka.prototype.f);var Ma={NONE:V.NONE,FIXED:V.h,DYNAMIC:V.g},Na,Oa,W,Pa;if(Object.keys)Na=Object.keys(Ma);else for(Oa in Na=[],W=0,Ma)Na[W++]=Oa;W=0;for(Pa=Na.length;W<Pa;++W)Oa=Na[W],ba("Zlib.Deflate.CompressionType."+Oa,Ma[Oa]);}).call(this); //@ sourceMappingURL=deflate.min.js.map


module.exports = Ka;
module.exports.compress = function(f,d){return(new Ka(f,d)).f()};
module.exports.prototype.compress = Ka.prototype.f;
module.exports.CompressionType = {   'NONE' : V.NONE,
                                    'FIXED' : V.h,
                                  'DYNAMIC' : V.g};
module.exports.CompressionType.NONE    = V.NONE;
module.exports.CompressionType.FIXED   = V.h;
module.exports.CompressionType.DYNAMIC = V.g;
